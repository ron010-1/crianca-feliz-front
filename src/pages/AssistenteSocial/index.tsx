...
export default function FormAssistenteSocial() {
    ...
    const navButtons = [
        { label: 'Voltar', onClick: () => navigate("/assistente"), variant: 'secondary' as const },
    ];
        ...
        <div className={Style.page}>
            ...
            <main className={Style.mainContainer}>
                <h1 className={Style.title}>
                    {isEditing ? "Editar assistente social" : "Cadastro de assistente social"}
                </h1>
                ...
                {errors.api && (
                    <div className={Style.apiErrorBox}>
                        {errors.api}
                    </div>
                )}
